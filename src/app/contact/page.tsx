                    ...
                    <div className="relative">
                      ...
                      <div className="relative bg-white/[0.04] backdrop-blur-xl border border-white/[0.08] rounded-2xl p-6 lg:p-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                          ...
                          <button
                            type="submit"
                            className="w-full text-white py-3.5 rounded-xl text-sm font-bold hover:shadow-xl hover:shadow-blue-500/25 transition-all duration-300 hover:scale-[1.01] flex items-center justify-center gap-2"
                            style={{
                          ...
                          <p className="text-center text-[11px] text-white/25">
                            No obligation. We&apos; review before recommending next steps.
                          </p>
                        </form>
                      </div>
                    </div>
